  ...
  return (
    <div className="min-h-screen bg-(--bg-color) flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-40 -right-32 w-80 h-80 bg-purple-500/10 rounded-full"></div>
        <div className="absolute -bottom-40 -left-32 w-80 h-80 bg-blue-500/10 rounded-full"></div>
