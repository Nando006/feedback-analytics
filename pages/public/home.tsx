          ...
          <div className="container mx-auto px-6 py-16 md:py-24">
            <div className="grid gap-10 md:grid-cols-[1.2fr_1fr] items-center">
              <div className="space-y-6">
                <p className="inline-flex items-center rounded-full border border-emerald-400/30 bg-emerald-500/10 px-4 py-1 text-xs font-semibold uppercase tracking-wide text-emerald-200">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link
                    to="/register"
                    className="rounded-lg bg-emerald-500 px-5 py-3 text-sm font-semibold text-neutral-950 transition hover:bg-emerald-400">
                    Começar agora
                  </Link>
                  <button
                    onClick={() => setShowVideo(true)}
                    className="rounded-lg border border-neutral-700 px-5 py-3 text-sm font-semibold text-neutral-200 transition hover:border-neutral-500 hover:bg-neutral-900">
                    Ver como funciona
                  </button>
                </div>
              ...
              <div className="relative">
                ...
                <div className="relative rounded-2xl border border-neutral-800 bg-neutral-900/60 p-6 shadow-2xl backdrop-blur">
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <div>
                      <div className="flex items-center justify_between text-sm text-neutral-300">
                        <span>Negativos</span>
                        <span>14%</span>
                      </div>
                      <div className="mt-2 h-2 rounded-full bg-neutral-800">
          ...
          <div className="relative w-full max-w-4xl rounded-2xl border border-neutral-800 bg-neutral-950/90 shadow-2xl overflow-hidden">
            <div className="flex items-center justify-between border-b border-neutral-800 px-6 py-4">
              ...
              <button
                ...
                className="rounded-full border border-neutral-700 px-3 py-1 text-sm text-neutral-200 hover:border-neutral-500 hover:bg-neutral-900">
                Fechar
              </button>
            </div>
            <div className="aspect-video w-full bg-neutral-900 flex items-center justify-center text-neutral-500 text-sm">
