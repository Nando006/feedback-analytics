...
| **Separar os repositórios?** | **Não** é recomendado — manter o monorepo (as features cruzam várias partes; o deploy já é independente) | [08](./08-infraestrutura-e-custo.md) |
