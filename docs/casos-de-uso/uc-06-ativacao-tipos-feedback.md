...
> Os testes E2E já estão implementados no Playwright ([uc-06-ativacao-tipos-feedback.spec.ts](file:///C:/Users/Fernando/Repositorios/feedback-analytics/apps/web/e2e/uc-06-ativacao-tipos-feedback.spec.ts)).
...
- **[CT-UC06-01]** ✅ *Coberto E2E* - Caminho feliz — ativar: gestor ativa o tipo "Produtos", salva e verifica que o badge "Ativo" e o link "Configurar catálogo de produtos" aparecem no card.
- **[CT-UC06-02]** ⚠️ *Skipped Intencional* - Caminho feliz — desativar: gestor desativa um tipo ativo, salva e verifica que o badge e o link de catálogo desaparecem.
- **[CT-UC06-03]** ❌ *Cenário não coberto* - Comportamento antes de salvar: ativar um toggle sem salvar deve exibir o aviso em âmbar, sem mostrar o badge "Ativo" ou o link de catálogo.
- **[CT-UC06-04]** ❌ *Cenário não coberto* - Exceção — erro ao salvar: simular falha de rede durante o salvamento deve exibir toast de erro sem alterar o estado salvo dos tipos.
