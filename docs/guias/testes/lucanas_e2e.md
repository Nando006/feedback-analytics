...
Este documento mapeia os conflitos, divergências e lacunas entre a documentação de **Casos de Uso (`docs/casos-de-uso/`)** e a implementação dos testes E2E com o **Playwright (`apps/web/e2e/`)**. 
...
| :--- | :--- | :--- | :--- |
| **[CT-UC01-01]** | Confirmação de e-mail ao criar conta | [uc-01-cadastro-conta.spec.ts](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/apps/web/e2e/uc-01-cadastro-conta.spec.ts) | Exige acessar uma caixa de e-mails real para clicar no link de validação. |
| **[CT-UC02-04]** | Login com conta criada mas pendente de confirmação | [uc-02-login.spec.ts](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/apps/web/e2e/uc-02-login.spec.ts) | Requer manter uma conta no banco de dados fixamente com e-mail não verificado. |
| **[CT-UC11-05]** | Executar nova análise chamando a API de IA | [uc-11-insights-ia.spec.ts](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/apps/web/e2e/uc-11-insights-ia.spec.ts) | A requisição HTTP real para a API do Gemini foi interceptada e mockada para **não consumir créditos financeiros** da conta do projeto. |
...
| **[CT-UC05-02]** | Download do arquivo `.png` com o nome da empresa | [uc-05-geracao-qrcode.spec.ts](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/apps/web/e2e/uc-05-geracao-qrcode.spec.ts) *(não implementado)* | Testar o download físico de uma imagem gerada via canvas e validar sua integridade estrutural (e nome do arquivo) é complexo no ambiente headless. |
| **[CT-UC05-04]** | Acionamento da API nativa de compartilhamento (`navigator.share`) | [uc-05-geracao-qrcode.spec.ts](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/apps/web/e2e/uc-05-geracao-qrcode.spec.ts) *(não implementado)* | A Web Share API necessita de suporte e permissão nativa do sistema operacional (SO) e geralmente falha ou não tem efeito em navegadores de teste. |
| **[CT-UC12-03]** | Envio de código de verificação por SMS para telefone | [uc-12-gestao-perfil.spec.ts](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/apps/web/e2e/uc-12-gestao-perfil.spec.ts) *(não implementado)* | Exige a simulação física de recebimento de SMS e extração do código numérico de 6 dígitos. |
...
### [UC-01: Cadastro de Conta](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/docs/casos-de-uso/uc-01-cadastro-conta.md)
...
### [UC-02: Login da Empresa](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/docs/casos-de-uso/uc-02-login.md)
...
### [UC-03: Recuperação de Senha](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/docs/casos-de-uso/uc-03-recuperacao-senha.md)
...
### [UC-04: Envio de Feedback via QR Code](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/docs/casos-de-uso/uc-04-envio-feedback-qrcode.md)
...
### [UC-05: Geração e Compartilhamento de QR Code](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/docs/casos-de-uso/uc-05-geracao-qrcode.md)
...
### [UC-06: Ativação de Tipos de Feedback](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/docs/casos-de-uso/uc-06-ativacao-tipos-feedback.md)
...
### [UC-07: Configuração do Catálogo](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/docs/casos-de-uso/uc-07-configuracao-catalogo.md)
...
### [UC-08: Configuração de Coleta (Contexto IA)](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/docs/casos-de-uso/uc-08-configuracao-coleta-ia.md)
...
### [UC-09: Visualização do Dashboard](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/docs/casos-de-uso/uc-09-dashboard.md)
...
### [UC-10: Listagem e Filtragem de Feedbacks](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/docs/casos-de-uso/uc-10-listagem-feedbacks.md)
...
### [UC-11: Disparo e Visualização de Insights IA](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/docs/casos-de-uso/uc-11-insights-ia.md)
...
### [UC-12: Gestão de Perfil](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/docs/casos-de-uso/uc-12-gestao-perfil.md)
