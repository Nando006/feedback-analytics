...
| **[CT-UC05-02]** | Download do arquivo `.png` com o nome da empresa | [uc-05-geracao-qrcode.spec.ts](file:///C:/Users/Fernando/Repositorios/feedback-analytics/apps/web/e2e/uc-05-geracao-qrcode.spec.ts) *(não implementado)* | Testar o download físico de uma imagem gerada via canvas e validar sua integridade estrutural (e nome do arquivo) é complexo no ambiente headless. |
| **[CT-UC05-04]** | Acionamento da API nativa de compartilhamento (`navigator.share`) | [uc-05-geracao-qrcode.spec.ts](file:///C:/Users/Fernando/Repositorios/feedback-analytics/apps/web/e2e/uc-05-geracao-qrcode.spec.ts) *(não implementado)* | A Web Share API necessita de suporte e permissão nativa do sistema operacional (SO) e geralmente falha ou não tem efeito em navegadores de teste. |
| **[CT-UC12-03]** | Envio de código de verificação por SMS para telefone | [uc-12-gestao-perfil.spec.ts](file:///C:/Users/Fernando/Repositorios/feedback-analytics/apps/web/e2e/uc-12-gestao-perfil.spec.ts) *(não implementado)* | Exige a simulação física de recebimento de SMS e extração do código numérico de 6 dígitos. |
...
### [UC-01: Cadastro de Conta](file:///C:/Users/Fernando/Repositorios/feedback-analytics/docs/casos-de-uso/uc-01-cadastro-conta.md)
...
### [UC-02: Login da Empresa](file:///C:/Users/Fernando/Repositorios/feedback-analytics/docs/casos-de-uso/uc-02-login.md)
...
### [UC-04: Envio de Feedback via QR Code](file:///C:/Users/Fernando/Repositorios/feedback-analytics/docs/casos-de-uso/uc-04-envio-feedback-qrcode.md)
...
### [UC-05: Geração e Compartilhamento de QR Code](file:///C:/Users/Fernando/Repositorios/feedback-analytics/docs/casos-de-uso/uc-05-geracao-qrcode.md)
...
### [UC-06: Ativação de Tipos de Feedback](file:///C:/Users/Fernando/Repositorios/feedback-analytics/docs/casos-de-uso/uc-06-ativacao-tipos-feedback.md)
...
### [UC-07: Configuração do Catálogo](file:///C:/Users/Fernando/Repositorios/feedback-analytics/docs/casos-de-uso/uc-07-configuracao-catalogo.md)
...
### [UC-08: Configuração de Coleta (Contexto IA)](file:///C:/Users/Fernando/Repositorios/feedback-analytics/docs/casos-de-uso/uc-08-configuracao-coleta-ia.md)
...
### [UC-09: Visualização do Dashboard](file:///C:/Users/Fernando/Repositorios/feedback-analytics/docs/casos-de-uso/uc-09-dashboard.md)
...
### [UC-10: Listagem e Filtragem de Feedbacks](file:///C:/Users/Fernando/Repositorios/feedback-analytics/docs/casos-de-uso/uc-10-listagem-feedbacks.md)
...
### [UC-11: Disparo e Visualização de Insights IA](file:///C:/Users/Fernando/Repositorios/feedback-analytics/docs/casos-de-uso/uc-11-insights-ia.md)
...
### [UC-12: Gestão de Perfil](file:///C:/Users/Fernando/Repositorios/feedback-analytics/docs/casos-de-uso/uc-12-gestao-perfil.md)
