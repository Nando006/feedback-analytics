...
- [Requisitos Não Funcionais — RNF02 → visao-geral.md#requisitos-não-funcionais-rnf](./visao-geral.md)
- [Regras de Negócio — RNE-011 → visao-geral.md#regras-de-negócio-rne](./visao-geral.md)
