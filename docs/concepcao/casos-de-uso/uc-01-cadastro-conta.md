...
> Os testes E2E já estão implementados no Playwright ([uc-01-cadastro-conta.spec.ts](https://github.com/TCC-Feedback-Analytics/feedback-analytics/blob/main/apps/web/e2e/uc-01-cadastro-conta.spec.ts)).
