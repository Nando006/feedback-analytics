...
```
           ╔═════════════════════╗
           ║     E2E (70)        ║  ← Playwright: Jornada real integrada (front + back + Supabase real)
           ╚═════════════════════╝
        ╔═══════════════════════════╗
...
* **Testes E2E (70 testes):** Validam cenários de negócio ponta a ponta em navegador Chrome real (via Playwright) cobrindo as jornadas dos 12 Casos de Uso integrados.
