...
describe('LayoutUser', () => {
  ...
  it.each([
    ...
    ['/user/feedbacks', 'Feedbacks All skeleton'],
    ['/user/feedbacks/123', 'Feedback Details skeleton'],
    ['/user/feedbacks', 'Feedbacks Analytics All skeleton'],
    ['/user/feedbacks?sentiment=positive', 'Feedbacks Analytics Positive skeleton'],
    ['/user/feedbacks?sentiment=negative', 'Feedbacks Analytics Negative skeleton'],
    ['/user/insights', 'Insights Report skeleton'],
    ['/user/insights', 'Insights Emotional skeleton'],
    ['/user/insights', 'Insights Statistics skeleton'],
    ['/user/edit/customers', 'Edit Customers skeleton'],
    ['/user/edit/profile', 'Edit Profile skeleton'],
    ['/user/settings/form', 'Edit Collecting Data skeleton'],
    ['/user/settings/form', 'Edit Feedback Settings skeleton'],
