      ...
      {summary.topCategories.length === 0 ? (
        ...
        <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
          <div className="space-y-2">
            <div className="text-xs uppercase tracking-wide text-[var(--text-tertiary)] font-work-sans">
            ...
            <ul className="space-y-1">
              {summary.topCategories.map((cat) => (
                <li
                  key={cat.name}
                  className="flex justify-between text-[var(--text-secondary)] font-work-sans">
                  <span>{cat.name}</span>
                  <span className="text-[var(--text-tertiary)] font-work-sans">{cat.count}x</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="space-y-2">
            ...
            {summary.topKeywords.length === 0 ? (
              <div className="text-sm text-[var(--text-tertiary)] font-work-sans">
