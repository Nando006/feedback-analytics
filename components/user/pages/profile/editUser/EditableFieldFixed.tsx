        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
          <div>
            ...
            <input
              ...
              className={`w-full rounded-lg border border-(--quaternary-color)/30 bg-(--seventh-color) px-4 py-3 text-(--text-primary) outline-none placeholder:text-(--text-tertiary) focus:border-(--primary-color) focus:ring-2 focus:ring-(--primary-color)/20 transition-all ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
            />
